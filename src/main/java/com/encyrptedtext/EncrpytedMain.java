...
public class EncrpytedMain {
    ...
    public static void marshallText(String originalString, String filename) {
        try{
            ...
            JAXBContext jContext = JAXBContext.newInstance(new Class[] {Text.class});
            ...
            result.setPassword(encryptedString);
    ...
    public static String unmarshallText(String filename) {
        try{
            ...
            String decryptedString = AES.decrypt(text.getPassword(), secretKey);
